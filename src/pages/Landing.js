      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div
            ...
            style={{ background: "var(--hero-gradient)", animationDelay: "1s" }}
          ></div>
        </div>
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-[var(--surface)] border border-[var(--border)] mb-6 animate-bounce">
              ...
              <span className="text-sm font-medium text-[var(--text-secondary)]">
                Join 10,000+ Cosplayers Worldwide
              </span>
            </div>
            ...
            <p className="text-xl text-[var(--text-secondary)] mb-10 max-w-2xl mx-auto leading-relaxed">
              Connect with the global cosplay community, discover events, rent
              amazing costumes, and showcase your creativity.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto">
              All-in-one platform for cosplayers to connect, create, and
              celebrate
            </p>
          </div>
          ...
          <Card className="border-0 overflow-hidden relative">
            ...
            <CardContent className="p-12 relative z-10 text-center">
              ...
              <p className="text-xl text-[var(--text-secondary)] mb-8 max-w-2xl mx-auto">
                Start your cosplay journey today and connect with thousands of
                passionate creators
              </p>
              <Link to="/register">
                <Button
