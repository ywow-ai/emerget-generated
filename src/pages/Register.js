    ...
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-secondary)]">Join the cosplay community today!</p>
        </div>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.fullName && <p className="text-sm text-[var(--error)]">{errors.fullName}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.username && <p className="text-sm text-[var(--error)]">{errors.username}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.password && <p className="text-sm text-[var(--error)]">{errors.password}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.confirmPassword && <p className="text-sm text-[var(--error)]">{errors.confirmPassword}</p>}
              </div>
              ...
              <div className="flex items-start space-x-2">
                <Checkbox
                  ...
                  className="mt-1"
                />
                <label htmlFor="agreeTerms" className="text-sm text-[var(--text-secondary)] leading-relaxed">
                  I agree to the{' '}
              ...
              {errors.agreeTerms && <p className="text-sm text-[var(--error)]">{errors.agreeTerms}</p>}
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[var(--card)] text-[var(--text-secondary)]">Or sign up with</span>
              </div>
            </div>
